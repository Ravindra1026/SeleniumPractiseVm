...
public class DataCopying02 {
    ...
    public void test_get_bihar_data() {
        ...
        // Now navigate through the rest of the pages (2 to pageNumber)
        for (int k = 1; k < pageNumber; k++) {
            if (nextPageElement.isDisplayed()) {
                nextPageElement.click();  // Go to the next page
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//table[@role='table']/tbody")));  // Wait for the page data to load
